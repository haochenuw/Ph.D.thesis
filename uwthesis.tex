...
\begin{Definition}
The old subspace of $S_k(N)$ is the span of $\alpha_d(S_k(M))$ where $M, d$ range over all divisors of $N$ s.t. $Md \mid N$. The new subspace of $S_k(N)$ is the ortogonal complement of the old subspace under the Petersson inner product. 
\end{Definition}
