...
In Chapter 3, we develop algorithms to compute Fourier expansions of $\Gamma_0(N)$-newforms at cusps other than the cusp at infinity. In Chapter 4 we study properties of Chow-Heegner points. We proved that the index of Chow-Heegner points are always divisible by two when the conductor $N$ has many prime divisors, and we develop algebraic algorithms to compute the Chow-Heegner points. 
}
