...
\end{question}
In \cite{delaunay2002thesis}, Christophe Delaunay performed numerical computations for the critical subgroups, but $E_{\crit}(\bQ)$ has not been provably computed for a single elliptic curve $E/\bQ$. 
...
Let $f \in S_k(\Gamma_0(N))$ be a normalized newform. Given the Fourier expansion of $f$ at the cusp $\infty$, compute its expansion at all other cusps of $X_0(N)$.
\end{problem}
