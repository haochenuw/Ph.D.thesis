...
For every curve $X$ there is a nonnegative integer $g(X)$ called its {\em genus}, and a field $k(X)$ of transcendence degree 1 over $K$, called the {\em function field} of $X$. We have the following fact:
\begin{Fact}
\label{fact: degree}
...
As another examples, let $E = {\bf 98a}$ and $c = [\frac{1}{14}]$. We computed numerically that
